 ...
 * {@link BufferedReader} which in conjunction with {@link InputStreamReader}
 * provides similar functionality, this class uses different end-of-input
 * reporting and a more restrictive definition of a line.
 * 
...
public class StrictLineReader implements Closeable {
	...
	/**
	 * Constructs a new {@code StrictLineReader} with the default capacity and
	 * charset.
	 * 
	 * @param in
	...
	/**
	 * Constructs a new {@code LineReader} with the specified capacity and the
	 * default charset.
	 * 
	 * @param in
	 *            the {@code InputStream} to read data from.
	 ...
	 *             for negative or zero {@code capacity}.
	 */
	public StrictLineReader(InputStream in, int capacity) {
		this(in, capacity, "US-ASCII");
	}
	 ...
	 */
	public StrictLineReader(InputStream in, String charset) {
	 ...
	 */
	public StrictLineReader(InputStream in, int capacity, String charset) {
		if (in == null) {
	 ...
	 * @throws IOException
	 *             for underlying {@code InputStream} errors or conversion
	 *             error.
	 * @throws EOFException
	 *             for the end of source stream.
	 */
	...
	/**
	 * Check whether there was an unterminated line at end of input after the
	 * line reader reported end-of-input with EOFException. The value is
	 * meaningless in any other situation.
	 * 
