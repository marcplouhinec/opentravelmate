	...
	private static class RequestHandler implements Runnable {
		...
		public void run() {
			...
			try {
				...
				exceptionListener.onException(false, new InternationalizedException(R.string.httpserver_error_connection_closed, e));
			} catch (IOException e) {
				exceptionListener.onException(false, new InternationalizedException(R.string.httpserver_error_io_error, e));
			} catch (HttpException e) {
				exceptionListener.onException(false, new InternationalizedException(R.string.httpserver_error_http_error, e));
			} finally {
				try {
